...
\textbf{srtp蒙特利尔议定书对全球微塑料分布的影响及建模——项目负责人} \hfill 2024.08 -- 至今 \titlebreak
项目描述：总体目标为评估《蒙特利尔议定书》实施对全球微塑料污染的间接影响，重点关注紫外线辐射水平的变化及其对塑料降解速率和微塑料生成的影响。首先，收集全球紫外线辐射数据，并分析臭氧层变化对地表紫外线辐射的长期影响，以形成高分辨率的网格化紫外线辐射数据集。其次，收集不同紫外线强度下常见塑料（如聚乙烯、聚丙烯等）的降解速率和微塑料生成数据，以量化紫外线在塑料降解过程中的作用，构建全球微塑料污染的空间分布，并采用数学建模方法，建立\textbf{紫外线辐射—塑料降解—微塑料生成的过程模型}。最后，通过情景分析，设定有无《蒙特利尔议定书》实施的两种情境，对未来微塑料污染的发展趋势进行预测，量化该协议对全球微塑料污染的环境效益。
% 在 itemize 的选项中，使用 topsep=\intraProjectListTopSep 来控制上边距
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    \item \textbf{核心产出}：掌握了从\textbf{数据采集、清洗、文献阅读、数学建模}等科研方法；撰写蒙特利尔议定书对微塑料污染的环境效益评估1份；学术论文一篇。
